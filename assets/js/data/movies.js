    ...
    slides: [
      {
        ...
        visual: "⬡",
        lesson: "Owner loneliness is a structural problem — and structure, unlike stamina, can be fixed.",
      ...
      },
      {
        ...
        lesson: "Doing every job yourself isn't dedication — it's the ceiling. The bottleneck is the owner's hours.",
      ...
      },
      {
        ...
        lesson: "The old bargain was payroll-first or stamina-limited. Agents are the third door: capacity without headcount.",
      ...
      },
      {
        ...
        lesson: "The shift that matters: AI stopped answering and started finishing. Judge tools by jobs owned, not answers given.",
      ...
      },
      {
        ...
        lesson: "A prompt gets an intern's guess; a briefed agent gets a specialist's draft. The difference is management, not the machine.",
      ...
      },
      {
        ...
        lesson: "Hire from an org chart, not an app store: find the role your business is missing, then copy its role card.",
      ...
      },
      {
        ...
        lesson: "Strategy is a hire now — ranked priorities, debated decisions, tomorrow's top three. Advisors used to be a luxury.",
      ...
      },
      {
        ...
        lesson: "Codify your voice once and every future asset sounds like you — even the ones you never touch.",
      ...
      },
      {
        ...
        lesson: "One true story in, fifteen platform-native assets out. Your job is the fifteen minutes of truth, not the typing.",
      ...
      },
      {
        ...
        lesson: "Speed-to-quote closes deals that brilliance loses. Systematize follow-up and silence stops killing pipeline.",
      ...
      },
      {
        ...
        lesson: "Love is logistics: answer fast, ask for the review at peak happiness, catch the drift before the goodbye email.",
      ...
      },
      {
        ...
        lesson: "A 13-week forecast turns cash ambushes into scheduled problems — solvable in week one with a phone call.",
      ...
      },
      {
        ...
        lesson: "Write the business out of your head. Documented playbooks are what make vacations — and buyers — possible.",
      ...
      },
      {
        ...
        lesson: "Ask for the three insights that change a decision, with confidence levels attached — certainty is a scam.",
      ...
      },
      {
        ...
        lesson: "Agents upgrade hiring instead of replacing it: scorecards, structured interviews, onboarding built from your best employee.",
      ...
      },
      {
        ...
        lesson: "Plain-English contracts and a one-page AI policy don't replace a lawyer — they make you ten times readier for one.",
      ...
      },
      {
        ...
        lesson: "Attack your own plan from six angles before the market does it for free.",
      ...
      },
      {
        ...
        lesson: "Write listings for humans AND the AI shopping agents buying on their behalf — and design for the second purchase.",
      ...
      },
      {
        ...
        lesson: "Staff your own life first: a morning brief, a commanded inbox, a calendar audited against what you claim to matter.",
      ...
      },
      {
        ...
        lesson: "The owner's real job is approve, adjust, redirect at the gates — twenty-five minutes replacing three hours of doing.",
      ...
      },
      {
        ...
        lesson: "Same-afternoon proposals and pre-emptive save plays are how a small shop out-operates bigger competitors.",
      ...
      },
      {
        ...
        lesson: "Run the math yourself: under $100/month of tools vs. $180k of equivalent labor — plus 10–16 owner-hours back weekly.",
      ...
      },
      {
        ...
        lesson: "Keep the skeptic: review gates, no secrets in prompts, verified facts, disclosed AI, autonomy earned in inches.",
      ...
      },
      {
        ...
        lesson: "Your context — voice, standards, playbooks — is the moat. Time in the system can't be bought back later.",
      ...
      },
      {
        ...
        visual: "⬡",
        lesson: "Start tonight: scan your DNA, run the audit, hire one specialist. The head chair is the only one empty.",
    ...
    slides: [
      {
        ...
        visual: "🧬",
        lesson: "Transformation starts with truth, not tools. Diagnose before you prescribe.",
      ...
      },
      {
        ...
        lesson: "Revenue up and collapse near can be the same fact: growth without systems adds chaos with every customer.",
      ...
      },
      {
        ...
        lesson: "'Work harder' stops being an option at 68 hours. The missing ingredient is information, not effort.",
      ...
      },
      {
        ...
        lesson: "Answer for the business you have today, not the one you keep meaning to build — the scan only works honest.",
      ...
      },
      {
        ...
        lesson: "Your strengths hide your weaknesses: active strands drive growth while dormant ones write next year's crisis.",
      ...
      },
      {
        ...
        lesson: "Recurring fires are usually one weak strand wearing many faces. Name the strand and the fires share one fix.",
      ...
      },
      {
        ...
        lesson: "Treatment is a casting sheet: one agent per dormant strand, one hire per week. A drip, not a revolution.",
      ...
      },
      {
        ...
        lesson: "Read the safety rules before the tool: drafts not decisions, no secrets in prompts, verify, disclose, one workflow at a time.",
      ...
      },
      {
        ...
        visual: "🧭",
        lesson: "A diagnosis plus one written procedure beats any grand plan. Know where you're bleeding; fix that first.",
    ...
    slides: [
      {
        ...
        visual: "⏳",
        lesson: "'Who has time to fix anything?' is the question the audit answers. The time is there — buried.",
      ...
      },
      {
        ...
        lesson: "Log three ordinary days in 30-minute blocks, tag Creator/Manager/Operator/Admin — the Operator+Admin share is your reclaimable zone.",
      ...
      },
      {
        ...
        lesson: "Price your hours honestly (target income ÷ 2,000) and the audit turns lost time into a number you can't unsee.",
      ...
      },
      {
        ...
        lesson: "Onboard agents on solved problems: feed your best past replies, have it draft answers you already know, grade fairly.",
      ...
      },
      {
        ...
        lesson: "One interview at a time, the business leaves your head — and new hires train against documents, not your calendar.",
      ...
      },
      {
        ...
        lesson: "The agents aren't getting smarter — your briefings are. Morning gate, afternoon gate, Friday retro: management is the skill.",
      ...
      },
      {
        ...
        lesson: "Decide in advance where reclaimed hours go — follow-ups, systems, dinner — or the inbox will quietly eat them again.",
      ...
      },
      {
        ...
        visual: "⏱️",
        lesson: "The friction felt like the job. Audit your week before you conclude you're out of capacity.",
    ...
    slides: [
      {
        ...
        visual: "🕸️",
        lesson: "Reclaimed time is fuel. Engines are systems that compound it whether or not you're watching.",
      ...
      },
      {
        ...
        lesson: "The machine needs one input only you can give: fifteen minutes of true stories every Monday.",
      ...
      },
      {
        ...
        lesson: "Buyers now ask AI assistants. Publish definitive, extractable answers and you become the citation — competitors vanish from it.",
      ...
      },
      {
        ...
        lesson: "Twenty minutes with a one-page Monday brief makes you the best-informed operator in your market. Then aim at rivals' unhappy customers.",
      ...
      },
      {
        ...
        lesson: "Big checks get councils, not gut feel: five agents, one identical brief, one forced vote — for the cost of an evening.",
      ...
      },
      {
        ...
        lesson: "Find your real constraint before buying growth — a cheaper test of the same market usually exists. The van, not the building.",
      ...
      },
      {
        ...
        lesson: "A follow-up cadence on every quote lifted close rate 31%→44% — same leads, same prices, zero new spend.",
      ...
      },
      {
        ...
        visual: "⚙️",
        lesson: "You don't need to become a technologist — just a better manager of a workforce that doesn't sleep.",
    ...
    slides: [
      {
        ...
        visual: "💎",
        lesson: "The last stage isn't more effort — it's a treasure hunt through your own books.",
      ...
      },
      {
        ...
        lesson: "Before chasing new revenue, collect your own: cancel zombie spend and chase finished-but-unpaid work with a friendly ladder.",
      ...
      },
      {
        ...
        lesson: "Rank every offer by true profit per hour with your own hours priced in — then promote the winner and reprice or refer out the loser.",
      ...
      },
      {
        ...
        lesson: "Fear charged rent for three years and never paid. Test the raise on new customers only, grandfather the rest, script every word.",
      ...
      },
      {
        ...
        lesson: "Overlay seasonality on a 13-week forecast: a trough seen in October gets an answer instead of an ambush.",
      ...
      },
      {
        ...
        lesson: "Keep a scoreboard with one 'unserious' metric — evenings home is the point, and what it measures is real.",
      ...
      },
      {
        ...
        lesson: "Week three is the danger zone: schedule the retro before motivation dips, ban tool tourism, keep the gates, include the team from day one.",
      ...
      },
      {
        ...
        lesson: "Documented systems pay twice: options now, and a premium if you ever sell.",
      ...
      },
      {
        ...
        visual: "⬡",
        lesson: "A composite beats a true story — it's repeatable. Every tool in the ninety days is already on this site.",
...
window.FILM_STUDY = {
  ...
  /* ---- The Chronicles — study guides for the five saga films ---- */
  "mv-intro": {
    title: "The Family field guide — making your first hire",
    protocol: [
      "Count the jobs you personally filled this week that appear in the film's thirteen departments",
      "Pick ONE department where the pain is loudest — not the one that sounds most exciting",
      "Open the AI Family page and read that department's role cards; choose a single specialist",
      "Copy the hire prompt and add your four contexts: business, customer, voice, standards",
      "Run one real task through it behind a review gate — nothing ships without your eye"
    ],
    rule: "A prompt is a request. An agent is a hire. Brief it like staff or get intern work.",
    drill: "Tonight, 10 minutes: list every role you personally filled today. Circle the one that drained the most. That's your first hire.",
    sell: { label: "Meet the whole family", href: "family.html" }
  },
  "mv-p1": {
    title: "The Diagnosis protocol — find the weak strand first",
    protocol: [
      "Run the 12-question Business DNA scan — answer for the business you HAVE today",
      "Read your two lowest strands: they are writing next year's crisis right now",
      "Match each dormant strand to its treatment agents (operations → Forge; finance → Stream and Hawk)",
      "Adopt the five safety rules BEFORE the first hire — drafts not decisions, no secrets in prompts",
      "Have your first agent produce one written procedure this week; save the DNA report as your before photo"
    ],
    rule: "Diagnose before you prescribe. An owner who skips this step is guessing with payroll.",
    drill: "Four minutes tonight: the DNA scan, answered honestly. Question three — the three-week disappearance test — tells you the most.",
    sell: { label: "Run your Business DNA scan", href: "dna.html" }
  },
  "mv-p2": {
    title: "The Liberation protocol — the forensic time audit",
    protocol: [
      "Track three ordinary days in 30-minute blocks — include the embarrassing ones",
      "Tag every block: Creator, Manager, Operator, or Admin",
      "Total the Operator + Admin share — that's the zone agents eat first",
      "Price it honestly: target annual income ÷ 2,000 hours × reclaimable hours",
      "Hire ONE agent for the single biggest leak; prove it before hire two",
      "Install the rhythm: morning gate, afternoon gate, Friday retro"
    ],
    rule: "The agents don't get smarter — your briefings do. The rhythm is the technology.",
    drill: "Right now, 10 minutes: reconstruct yesterday in 30-minute blocks and tag each one. Count the Operator/Admin blocks; multiply by your hourly rate.",
    sell: { label: "Run the Time Gap Analyzer", href: "time-audit.html" }
  },
  "mv-p3": {
    title: "The Engines protocol — systems that compound",
    protocol: [
      "Marketing engine: record 15 minutes of true stories every Monday; agents build the week behind your gate",
      "Answer engine: publish definitive, extractable answers to your customers' real questions",
      "Intelligence swarm: one Monday brief — competitors, trends, reviews, benchmarks — ending in ONE recommended action",
      "Council pattern: any five-figure decision gets five agents, one identical brief, and a forced vote",
      "Follow-up cadence on every quote: day-2 check-in, day-5 value, day-12 graceful close"
    ],
    rule: "Big checks get councils, not gut feel. The best money is the money you don't burn.",
    drill: "Tonight, 10 minutes: record your first Monday voice note — one customer story, one strong opinion, and answers to the three questions customers asked last week.",
    sell: { label: "Open the growth playbooks", href: "playbooks.html" }
  },
  "mv-p4": {
    title: "The Compound protocol — the 7-day profit sprint",
    protocol: [
      "Days 1–2: expense autopsy (zombie subscriptions, oversized plans) + receivables sweep with a friendly ladder",
      "Days 3–4: margin table — every offer's true profit per hour, your own hours priced in",
      "Day 5: the price test you've been dodging — new customers only, grandfather the rest, script every word",
      "Days 6–7: 13-week forecast + seasonality overlay; answer the trough while it's still months away",
      "Day 91: read the scoreboard — including the 'unserious' metric that is actually the point"
    ],
    rule: "The money is already in the business. It just needs someone with time to look.",
    drill: "Tonight, 10 minutes: list every subscription you pay for and mark the ones untouched in 60 days. That's sprint day one, already done.",
    sell: { label: "Run the Profit Lab", href: "profit.html" }
  }
};
